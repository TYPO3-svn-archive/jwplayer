...
<T3locallang>
    <meta type="array">
        <description>Adds Header to New Content Wizard</description>
    </meta>
    <data type="array">
        <languageKey index="default" type="array">
            <label index="jwplayer.title">JW Player</label>
            <label index="jwplayer.description">Adds a movie player.</label>
        </languageKey>
        <languageKey index="dk" type="array">
        </languageKey>
        <languageKey index="de" type="array">
            <label index="jwplayer.title">JW Player</label>
            <label index="jwplayer.description">Fügt eine Video ein.</label>
        </languageKey>
